...
/**
 * @description 관리자 주문ID 정보 조회
 * @method GET
 * @request @headers youngdong token
 */
const get_order_admin_orders_detail = (orderId) => {
  return fetch(`${_.SERVER_URL}/api/order/v1/admin/orders/${orderId}`, {
    method: 'GET',
    headers: {
...
export default get_order_admin_orders_detail;
