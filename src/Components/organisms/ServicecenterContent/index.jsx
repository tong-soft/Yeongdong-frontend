...
import counselingTime from "../../../assets/images/counselingTime.png"
                ...
                <Col span={9} justify={"center"} align={"center"}>
                    <Row justify={"center"} align={"center"} >
                        <Col span={12} style={{ borderBottom: "3px solid #ededed", padding: "1rem 0" }}>
                            <Image src={counselingTime} alt={"Counseling Time"} width={"13rem"} />
                        </Col>
                        <Col span={12} justify={"center"} align={"center"} style={{ padding: "2rem 0" }}>
                            <Image src={counselingExp} alt={"Counseling Time"} width={"90%"} />
                        </Col>
                    </Row>
                </Col>
                <Col span={12} style={{ borderTop: "3px solid #ededed", padding: "1rem 0" }}>
                    <Row>
                        ...
                        <Col span={10}>
                            <Col span={12} style={{ padding: '1rem 0' }}>
                                {
                                    service === "inquiry" ?
                                        <Image src={inquiryIcon} width={"15rem"} height={"4rem"} />
                                        :
                                        <Image src={announceIcon} width={"15rem"} height={"4rem"} />
                                }
                            </Col>
